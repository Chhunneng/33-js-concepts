...
[![Twitter](https://img.shields.io/twitter/url/https/twitter.com/Chanchhunneng.svg?style=social&label=Follow%20%40Chanchhunneng)](https://twitter.com/Chanchhunneng)

<!-- [![Follow me](https://img.shields.io/twitter/follow/leonardomso.svg?style=for-the-badge)](https://twitter.com/leonardomso) -->

## សេចក្តីផ្តើម 

Repository នេះត្រូវបានបង្កើតឡើងក្នុងគោលបំណងជួយអ្នកអភិវឌ្ឍន៍ឱ្យយល់ច្បាស់ពីគំនិតនៅក្នុង JavaScript។ វាមិនមែនជាតម្រូវការទេ ប៉ុន្តែជាការណែនាំសម្រាប់ការសិក្សានាពេលអនាគត។ វាត្រូវបានផ្អែកលើអត្ថបទដែលសរសេរដោយ [Stephen Curtis](https://twitter.com/stephenthecurt) ហើយអ្នកអាចអានវាបាន[នៅទីនេះ](https://medium.com/@stephenthecurt/33-fundamentals-every-javascript-developer-should-know-13dd720a90d1)។

**🚀 ចាត់​ទុក​ដោយ GitHub [top open source projects of 2018!](https://blog.github.com/2018-12-13-new-open-source-projects/)**
...
---
## <img  align= center width=50px height=50px src="https://media4.giphy.com/media/3hoLIVAJYkz6T0Ichp/giphy.gif?cid=6c09b952m4j3poopinf91rquev6qy4e8avu0bflq1e0vh4gp&ep=v1_internal_gif_by_id&rid=giphy.gif&ct=s"> <a id="table-of-contents">តារាង​មាតិកា</a>
...
**[⬆ ត្រលប់​ទៅ​ខាងលើ](#table-of-contents)**
...
**[⬆ ្រលប់​ទៅ​ខាងលើ](#table-of-contents)**
